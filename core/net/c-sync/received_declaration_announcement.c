        ...
        case ELECTION_DECLARATION:
          if(a_value->instr == my_state)
          {
            if(n->degree > my_degree || (n->degree == my_degree && n->addr > my_addr))
            {
              ...
              // To reduce instability of the testbed
#if TEST_BYZ
              if((n->addr == 69) && ((my_addr == 66) || (my_addr == 64)))
              {
                n->addr = 65;
                a_value->ref_addr = 65;
              }
              else if((n->addr == 65) && ((my_addr == 66) || (my_addr == 64)))
              {
                n->addr = 69;
                a_value->ref_addr = 69;
              }
              if(!handle_lists(a, a_value, n))
              {
                PRINTF("Couldn't add the new CH to make it CB\n");
              }
#endif

#if MOD_NEIGHBOURS && MOD_TYPE == 2
              if((n->addr == 71) && (my_addr == 70))
              {
                n->addr = 62;
                a_value->ref_addr = 62;
              }
              else if((n->addr == 62) && (my_addr == 70))
              {
                n->addr = 71;
                a_value->ref_addr = 71;
              }

              if((n->addr == 69) && (my_addr == 66))
              {
                n->addr = 71;
                a_value->ref_addr = 71;
              }
              else if((n->addr == 71) && (my_addr == 66))
              {
                n->addr = 69;
                a_value->ref_addr = 69;
              }

              if((n->addr == 69) && (my_addr == 76))
              {
                n->addr = 64;
                a_value->ref_addr = 64;
              }
              else if((n->addr == 64) && (my_addr == 76))
              {
                n->addr = 69;
                a_value->ref_addr = 69;
              }
              ...
              if((n->addr == 64) && (my_addr == 56))
              {
                n->addr = 51;
                a_value->ref_addr = 51;
              }
              else if((n->addr == 51) && (my_addr == 56))
              {
                n->addr = 64;
                a_value->ref_addr = 64;
              }
